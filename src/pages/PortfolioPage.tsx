...
const projects = [
  ...
  },
  {
    ...
    reviews: 94,
    description:
      "A stunning 3D-animated series exploring a futuristic metropolis and its inhabitants. This project pushed the boundaries of our 3D capabilities, featuring advanced particle systems, dynamic lighting, and complex character rigging. The series tells the story of a society where technology and nature have found perfect harmony.",
  },
  {
    title: "The Lost Kingdom",
    category: "Comics & Story Books",
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <span className="inline-block px-3 py-1 text-sm text-sky-500 bg-sky-500/10 rounded-full mb-2">
                      {project.category}
                    </span>
